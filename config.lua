...
Config.Animations = {
	
	{
	    ...
	    {label = "Accouder au comptoir", type = "scenario", data = {anim = "PROP_HUMAN_BUM_SHOPPING_CART"}},
...

	{
	    ...
	    {label = "Marteau piqueur", type = "scenario", data = {anim = "WORLD_HUMAN_CONST_DRILL"}},
	    {label = "Souffleur", type = "scenario", data = {anim = "WORLD_HUMAN_GARDENER_LEAF_BLOWER"}},
	    {label = "Soudure", type = "scenario", data = {anim = "WORLD_HUMAN_WELDING"}},
...

	{
	    ...
	    {label = "Craquer poings 1", type = "anim", data = {lib = "anim@mp_player_intcelebrationfemale@knuckle_crunch", anim = "knuckle_crunch"}},
	    {label = "Craquer poings 2", type = "anim", data = {lib = "anim@mp_player_intcelebrationmale@knuckle_crunch", anim = "knuckle_crunch"}},			
